    ...
    <main className="min-h-screen" style={{ backgroundColor: 'var(--bg-dark)' }}>
      <div className="max-w-4xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="space-y-8">
          <div className="rounded-2xl p-8 md:p-12 shadow-lg" style={{ backgroundColor: 'var(--card-bg)', border: '1px solid var(--border-subtle)' }}>
            <div className="space-y-6 text-lg leading-relaxed" style={{ color: 'var(--text-main)' }}>
              ...
              <p className="font-semibold antialiased" style={{ color: 'var(--text-accent)' }}>
