...
gdjs.GameCode.GDJumpbuttonObjects5= [];
gdjs.GameCode.GDJumpbuttonObjects6= [];
gdjs.GameCode.GDDuckButton2Objects1= [];
gdjs.GameCode.GDDuckButton2Objects2= [];
gdjs.GameCode.GDDuckButton2Objects3= [];
gdjs.GameCode.GDDuckButton2Objects4= [];
gdjs.GameCode.GDDuckButton2Objects5= [];
gdjs.GameCode.GDDuckButton2Objects6= [];
...
gdjs.copyArray(runtimeScene.getObjects("SCORE_TEXT"), gdjs.GameCode.GDSCORE_9595TEXTObjects2);
gdjs.copyArray(runtimeScene.getObjects("TutorialSprite"), gdjs.GameCode.GDTutorialSpriteObjects2);
{for(var i = 0, len = gdjs.GameCode.GDSCORE_9595TEXTObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDSCORE_9595TEXTObjects2[i].getBehavior("Text").setText("Touch to start running.");
}
}
{for(var i = 0, len = gdjs.GameCode.GDTutorialSpriteObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDTutorialSpriteObjects2[i].hide(false);
}
}
}
...
{gdjs.evtTools.sound.playMusic(runtimeScene, "Respeten los rangos audio.mp3", false, 35, 1);
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13620860);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13516652);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13519044);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDDinoObjects5 */
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13519852);
}
}
if (isConditionTrue_0) {
...
gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDDuckButton2Objects3Objects = Hashtable.newFrom({"DuckButton2": gdjs.GameCode.GDDuckButton2Objects3});
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13522132);
}
}
}
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("DuckButton2"), gdjs.GameCode.GDDuckButton2Objects3);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.input.cursorOnObject(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDDuckButton2Objects3Objects, runtimeScene, true, false);
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Dino"), gdjs.GameCode.GDDinoObjects3);
{for(var i = 0, len = gdjs.GameCode.GDDinoObjects3.length ;i < len;++i) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13517660);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("DustParticles"), gdjs.GameCode.GDDustParticlesObjects4);
...
if (isConditionTrue_0) {
{runtimeScene.getScene().getVariables().getFromIndex(5).setNumber(gdjs.randomInRange(1, 1 + Math.round(gdjs.evtTools.common.clamp(runtimeScene.getGame().getVariables().getFromIndex(0).getAsNumber() / 3000, 0, 2))));
}
...
gdjs.copyArray(runtimeScene.getObjects("SCORE_TEXT"), gdjs.GameCode.GDSCORE_9595TEXTObjects2);
{for(var i = 0, len = gdjs.GameCode.GDSCORE_9595TEXTObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDSCORE_9595TEXTObjects2[i].getBehavior("Text").setText("Score   " + gdjs.evtTools.variable.getVariableString(runtimeScene.getGame().getVariables().getFromIndex(0)));
}
}
...
gdjs.GameCode.GDJumpbuttonObjects5.length = 0;
gdjs.GameCode.GDJumpbuttonObjects6.length = 0;
gdjs.GameCode.GDDuckButton2Objects1.length = 0;
gdjs.GameCode.GDDuckButton2Objects2.length = 0;
gdjs.GameCode.GDDuckButton2Objects3.length = 0;
gdjs.GameCode.GDDuckButton2Objects4.length = 0;
gdjs.GameCode.GDDuckButton2Objects5.length = 0;
gdjs.GameCode.GDDuckButton2Objects6.length = 0;
